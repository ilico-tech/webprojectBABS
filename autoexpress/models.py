...
class Voiture(models.Model):
    ...
    service=models.CharField(max_length=20, choices=SERVICES,default=SERVICES)
    marque=models.CharField(max_length=20,null=True,blank=True)
    categorie=models.CharField(max_length=10,null=True,blank=True)
    ...
    boitevitesse = models.CharField(max_length=20, null=True, blank=True)
